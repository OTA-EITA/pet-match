                  ...
                  <div className="flex items-center justify-between border-t border-gray-100 pt-4">
                    <div className="flex gap-2">
                      ...
                      <Link
                        ...
                        className="inline-flex items-center gap-1 px-4 py-2 bg-[#FF8C00] text-white rounded-lg hover:bg-[#E67E00] transition-colors text-sm"
                      >
...
export default function ReceivedInquiriesPage() {
  return <ReceivedInquiriesContent />;
}
